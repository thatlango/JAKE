...
export const SEED_DATA = {
  projects: [
    ...
    },
    {
      ...
      name: 'Ajura Clothes',
      emoji: '👗',
      description: 'Faith-driven African fashion brand. AjuraFit product line. React/Netlify storefront. Security audit framework in place.',
      tech: 'Figma · React · Netlify · CSS',
      status: 'In Development',
      priority: 'High',
      color: '#9F7AEA',
      progress: 35,
      tasks: [
        ...
        { id: 2, text: 'Netlify deploy spec', done: true },
